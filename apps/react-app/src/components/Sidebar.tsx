...
export function Sidebar({ logo }: SidebarProps) {
  ...
  return (
    <div className="fixed top-0 left-0 h-screen w-64 z-30 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      <div className="flex flex-col flex-1 overflow-y-auto">
        ...
        {user && (
          <div className="flex-shrink-0 flex border-t border-gray-200 dark:border-gray-700 p-4 mt-auto">
