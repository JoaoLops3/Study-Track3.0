      ...
      <nav className="flex-1 px-4 mt-4 overflow-y-auto">
        ...
        <div className="mt-6">
          ...
          <ul className="space-y-1">
            <li>
              <Link
                to="/board/73262a9b-9efa-4b58-af14-dffa9257ce01"
                className={`flex items-center px-3 py-2 text-sm rounded-md transition-colors text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800`}
              >
                <Folder className="w-4 h-4 mr-3 flex-shrink-0" />
                {!isCollapsed && (
                  <span className="truncate">Meu Primeiro Board</span>
                )}
              </Link>
            </li>
            <li>
              <Link
                to="/board/51fc7231-c3c5-4f91-8fe2-f8b687765d64"
                className={`flex items-center px-3 py-2 text-sm rounded-md transition-colors text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800`}
              >
                <Folder className="w-4 h-4 mr-3 flex-shrink-0" />
                {!isCollapsed && (
            ...
            <li>
              <Link
                to="/board/709e63d3-ef7e-4fce-9cfa-ef4f9cbeeaf6"
                className={`flex items-center px-3 py-2 text-sm rounded-md transition-colors text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800`}
              >
                <Folder className="w-4 h-4 mr-3 flex-shrink-0" />
        ...
        <div className="mt-6">
          ...
          <ul className="space-y-1">
            <li>
              <Link
                to="/page/b860707e-8479-416a-b990-a7ff3249f858"
                className={`flex items-center px-3 py-2 text-sm rounded-md transition-colors text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800`}
              >
