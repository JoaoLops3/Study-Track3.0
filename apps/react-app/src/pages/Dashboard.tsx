    ...
    return recentPages.filter((page) => {
      const matchesSearch =
        ...
        (typeof page.content === "object" &&
          ...
          (page.content as any).content[0]?.content?.[0]?.text
            ?.toLowerCase()
              ...
              {availableTags.map((tag) => (
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-tag w-4 h-4"
                  >
              ...
              >
                {filteredBoards.map((board) => (
                  ...
                  >
                    <button
                      onClick={() =>
                        toggleFavorite("board", board.id, board.is_favorite)
                      }
              ...
              >
                {filteredPages.map((page) => (
                  ...
                  >
                    <button
                      onClick={() =>
                        toggleFavorite("page", page.id, page.is_favorite)
                      }
                      className="absolute top-2 right-2 p-1 rounded-full dark:hover:bg-gray-700 hover:bg-gray-100"
                    >
                      <svg
